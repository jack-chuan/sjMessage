 ...
 */
public interface LYGPersonService extends IService<LYGPersonEntity> {

    List<LYGPersonEntity> queryAllList();

    List<MsPersonEntity> changeList(List<LYGPersonEntity> lygPersonEntityList);
}
