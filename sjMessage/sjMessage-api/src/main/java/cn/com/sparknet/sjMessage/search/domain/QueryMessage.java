...
@Document(indexName="querymessage",type="doc",shards=5,replicas=1)
public class QueryMessage implements Serializable{
	...
	public String getSendScopeName() {
		return sendScopeName;
	}

	public void setSendScopeName(String sendScopeName) {
		this.sendScopeName = sendScopeName;
	}
